'use strict'
{
    globalThis.C3.Plugins.PlaygamaBridge.Instance = class PlaygamaBridgeInstance extends globalThis.ISDKInstanceBase {
        constructor() {
            super()

            this.conditions = globalThis.C3.Plugins.PlaygamaBridge.Cnds
            this.actions = globalThis.C3.Plugins.PlaygamaBridge.Acts
            ...
            if (properties[0]) {
                this.runtime.AddLoadPromise(this.loadSdk(cdnUrl))
            }

            this.runtime.AddLoadPromise(this.initializeSdk())
